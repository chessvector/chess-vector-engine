...
fn play_game(
    ...
    println!("   3. Tactical Search Fallback ({}+ ply minimax with pruning)", tactical_depth);
    ...
    while game_state.game.result().is_none() && move_count < 200 {
        ...
        if is_chess_vector_turn {
            ...
            println!("🎯 Stockfish plays: {} (eval: {:.2})", best_move, eval_after);
    ...
    // Save PGN to file
    let filename = format!("chess_vector_vs_stockfish_safe_{}.pgn", 
